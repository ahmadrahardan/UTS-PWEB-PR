...
<body>
    <header class="bg-slate-950 fixed px-10 py-6 flex justify-between items-center w-full z-50">
        ...
        <div class="flex space-x-4">
            <a href="{{ route('login') }}"
                class="rounded-2xl border-2 border-white text-white px-6 py-1 hover:bg-white hover:text-slate-950 transition font-medium">
                Login
            </a>
            <a href="#"
                class="rounded-2xl border-2 border-white text-white px-6 py-1 hover:bg-white hover:text-slate-950 transition font-medium">
        ...
        <div class="w-full mx-auto flex flex-col items-center space-y-8 px-10">
            <div class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 w-full justify-center">
                ...
                <div class="flex-1 overflow-hidden h-[530px] flex flex-col">
                    ...
                    <div class="sm:pl-40 max-w-xl mt-5 sm:mt-0 text-center sm:text-right">
                        ...
                        <p class="mt-1 text-gray-600 text-xs">
                            Nikmati perjalanan nyaman dan aman bersama Megah Transport! Dengan fasilitas lengkap, AC
                            sejuk,
                            kursi ergonomis, serta layanan ramah, kami siap mengantar Anda ke berbagai kota tujuan
                            dengan
                ...
                <div class="relative group hidden sm:block flex-1 overflow-hidden shadow-md h-[530px] cursor-pointer">
                    <img src="{{ asset('assets/D2.png') }}" alt="Megah"
                        class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out group-hover:opacity-0">
                    <img src="{{ asset('assets/P3.png') }}" alt="Megah"
                        class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out opacity-0 group-hover:opacity-100">
                </div>
            </div>
        </div>
