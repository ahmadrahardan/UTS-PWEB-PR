            ...
            <div class="rounded-3xl p-10 w-full max-w-md sm:max-w-lg relative shadow-lg border-2 border-slate-950">
                ...
                <form action="{{ route('login.submit') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="username" placeholder="Masukkan username" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-slate-100">
                    </div>
                    <div>
                        <label class="block mb-1 text-gray-700 font-medium">Password</label>
                        <input type="password" name="password" placeholder="Masukkan password" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-slate-100">
                    </div>
                    <button type="submit" class="w-full bg-slate-950 text-white font-semibold py-3 rounded-lg hover:bg-slate-700 border-2 transition">
                        Masuk
                    </button>
                </form>
            </div>
