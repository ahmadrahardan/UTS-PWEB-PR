...
<header x-data="{ open: false, userOpen: false }" class="bg-slate-950 fixed px-8 py-6 flex justify-between items-center w-full text-white z-50">
    <div>
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="relative">
            ...
            <div x-show="userOpen" @click.outside="userOpen = false" class="absolute right-0 mt-2 w-28 p-3 rounded-lg bg-white text-slate-950 shadow-lg z-50">
                <a href="{{ route('profile', ['username' => $username, 'password' => $password]) }}" class="block px-4 py-2 rounded-lg hover:bg-slate-950 hover:text-white">Profile</a>
    ...
    <div x-show="open" @click.outside="open = false"
        ...
        <a href="{{ route('dashboard', ['username' => $username, 'password' => $password]) }}" class="block px-6 py-3 border-t border-slate-800 hover:bg-slate-800">Dashboard</a>
        <a href="{{ route('pengelolaan', ['username' => $username, 'password' => $password]) }}" class="block px-6 py-3 border-t border-slate-800 hover:bg-slate-800">Fleet</a>
    </div>
</header>
