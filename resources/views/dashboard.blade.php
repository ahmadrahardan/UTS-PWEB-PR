        ...
        <div class="w-full px-20 mx-auto mt-20">
            <div class="flex space-x-6 border-b border-slate-950 pb-2 mb-6 text-sm font-semibold">
                <button @click="filter = 'all'"
                    :class="filter === 'all' ? 'bg-slate-950 text-white' :
                        'text-slate-950 hover:bg-slate-950 hover:text-white'"
                    class="px-4 py-1 rounded">
                    ALL CLASS
                </button>
                <button @click="filter = 'executive'"
                    :class="filter === 'executive' ? 'bg-slate-950 text-white' :
                        'text-slate-950 hover:bg-slate-950 hover:text-white'"
                    class="px-4 py-1 rounded">
                    EXECUTIVE CLASS
                </button>
                <button @click="filter = 'urban'"
                    :class="filter === 'urban' ? 'bg-slate-950 text-white' :
                        'text-slate-950 hover:bg-slate-950 hover:text-white'"
                    class="px-4 py-1 rounded">
                    URBAN CLASS
                </button>
